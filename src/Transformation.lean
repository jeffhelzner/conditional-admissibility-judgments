...
structure CJTransformation
  ...
  g : K' → K
  /-- Every element of χ.E arises as the preimage of some
      element of χ'.E. Weaker than global surjectivity of f. -/
  f_preimage_surjective_on_E :
    ∀ e, e ∈ χ.E → ∃ e', e' ∈ χ'.E ∧ f ⁻¹' e' = e
  /-- Preimages of χ'.E-elements lie in χ's set algebra. -/
